...
@testset "PlasmaFormularyZ.jl" begin
    @testset "Misc" begin
        @test gyroradius(0.2u"T", Unitful.mp, Unitful.q, 1e6u"K") ≈ 0.0067u"m" rtol = 0.01
        @test_broken electron_gyroradius(1e6u"K", 0.2u"T", Unitful.q, Unitful.mp) ≈
                     0.0067u"m" rtol = 0.01
    ...
    @testset "dimensionless.jl" begin
        ...
        ) ≈ ustrip(u"m", PlasmaFormularyZ.debye_length(1e19 * u"m^-3", 10 * u"eV")) rtol =
            1e-3
    end
